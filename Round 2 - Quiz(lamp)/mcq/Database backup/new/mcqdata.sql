...
--
-- Host: localhost
-- Generation Time: Feb 06, 2017 at 08:41 AM
...
(1, 'root', '393bf99b6cf423823c00dc8102c55c3c');
...
(2, 'Male', 'kurus', 'Computer', 'kuruss@gmail.com', '2524aab769a59f46fc5efcf850e554d4', 2, 1, 2),
(3, 'Male', 'paritosh', 'Computer', 'paritosh.medhekar@gmail.com', '99d1933b3df3a2a4616c1aca2aec955c', 3, 1, 3);
...
CREATE TABLE `time_and_questions` (
...
--
-- Indexes for table `enable_mcq`
--
ALTER TABLE `enable_mcq`
  ADD UNIQUE KEY `mcq_state` (`mcq_state`);

--
-- Indexes for table `marking_scheme`
--
ALTER TABLE `marking_scheme`
  ADD UNIQUE KEY `negative_marking` (`negative_marking`);
...
--
-- Indexes for table `time_and_questions`
--
ALTER TABLE `time_and_questions`
...
--
-- AUTO_INCREMENT for table `time_and_questions`
--
ALTER TABLE `time_and_questions`
  MODIFY `serial_num` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
